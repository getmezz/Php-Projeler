...
<div id="container">
<div id="copyright">
<div id="copy">Copyright &copy; <?php echo date("Y"); ?> <?php echo "$sitename"; ?>. All Right Reserved. Design By <a href="http://www.primerthemes.com" target="_blank">Primer Themes</a>.</div>
</div>
</div>
</div>
</body>
